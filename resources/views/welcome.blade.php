...
<body class="bg-white">
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <header class="flex-col xl:flex-row flex justify-between">
                ...
                <div class="mx-auto text-center xl:text-left xl:mx-0 mb-20 xl:mb-0">
                    <h1 class="font-bold text-gray-700 text-3xl md:text-6xl leading-tight mb-10">A digital <br> Product
                        design <br> Agency</h1>

                    <p class="font-normal text-gray-500 text-sm md:text-lg mb-10">We develop world class high quality
                        product <br> designs.</p>

                    <div class="flex items-center justify-center lg:justify-start">
                        <a href="#"
                            class="px-8 py-3 bg-green-500 font-medium text-white text-md md:text-lg rounded-md hover:bg-green-700 transition ease-in-out duration-300 mr-14">Our
                            story</a>

                        <a href="#" class="hidden lg:block font-normal text-gray-500 text-lg mr-8">Watch
                            Showreel</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                <div class="text-center mb-10 xl:mb-0">
                    <div class="flex items-center justify-center">
                        <div
                            class="w-20 py-7 flex justify-center bg-purple-50 text-purple-500 rounded-md mb-5 md:mb-10">
                    ...
                    <p class="font-normal text-gray-400 text-sm md:text-lg">Excepteur sint occaecat cupidatat non <br>
    ...
    <section class="py-8 md:py-16">
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <p class="font-normal text-gray-500 text-md md:text-lg text-center mb-20 md:mb-40">Excepteur sint occaecat
            ...
            <div class="flex flex-col xl:flex-row items-center justify-between mb-20 md:mb-40">
                ...
                <div class="mx-auto xl:mx-0 text-center xl:text-left">
                    <h1 class="font-bold text-gray-700 text-3xl md:text-4xl mb-10">Design is our most intense <br>
                        process</h1>

                    <p class="font-normal text-gray-400 text-sm md:text-lg mb-5">Duis aute irure dolor in reprehenderit
                        in voluptate velit esse cillum <br> dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                        cupidatat <br> non proident, sunt in culpa qui officia deserunt mollit anim id est <br> laborum.
                    </p>
            ...
            <div class="flex flex-col xl:flex-row items-center justify-between mb-20 md:mb-40">
                <div class="mx-auto xl:mx-0 text-center xl:text-left mb-20 xl:mb-0">
                    <h1 class="font-bold text-gray-700 text-3xl md:text-4xl mb-10">Don’t worry about the investment,
                        <br> it will come back.</h1>
            ...
            <div class="flex flex-col xl:flex-row items-center justify-between">
                ...
                <div class="mx-auto xl:mx-0 text-center xl:text-left">
                    <h1 class="font-bold text-gray-700 text-3xl md:text-4xl mb-10">Instantly understandable content <br>
                        is important</h1>
    ...
    <section class="py-8 md:py-16">
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <p class="font-normal text-gray-500 text-md md:text-lg text-center mb-20">Excepteur sint occaecat cupidatat
                non proident, sunt in culpa qui officia deserunt mollit <br> anim id est laborum.</p>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-10">
                <div class="space-y-2 xl:space-y-4">
                    <img src="assets/image/yoga-1.svg" alt="Image"
                    ...
                    <a href="#"
                        class="block font-semibold text-gray-700 text-xl md:text-2xl hover:text-green-500 transition ease-in-out duration-300">Yoga
                        School</a>
                </div>

                <div class="space-y-2 xl:space-y-4">
                    <img src="assets/image/yoga-2.svg" alt="Image"
                        class="hover:opacity-75 transition ease-in-out duration-300">
                ...
                <div class="space-y-2 xl:space-y-4">
                    <img src="assets/image/yoga-3.svg" alt="Image"
                        class="hover:opacity-75 transition ease-in-out duration-300">
            ...
            <p class="font-normal text-gray-500 text-md md:text-lg mb-4 md:mb-10">Excepteur sint occaecat cupidatat non
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <div class="lg:flex flex-col md:flex-row text-center lg:text-left lg:justify-between">
                <div class="mb-10 lg:mb-0">
                    ...
                    <p class="font-normal text-gray-400 text-md">Excepteur sint occaecat cupidatat non <br> proident,
                ...
                <div class="space-y-4 mb-10 lg:mb-0">
                    ...
                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Pricing</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">UI
                        Design</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Animation</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Development</a>
                </div>
                ...
                <div class="space-y-4 mb-10 lg:mb-0">
                    ...
                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Reporting</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Get
                        in Touch</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">Management</a>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">121
                        King St, VIC3000, US</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">888-123-42287</a>

                    <a href="#"
                        class="block font-normal text-gray-400 text-md hover:text-gray-700 transition ease-in-out duration-300">info@example.com</a>
                </div>
            </div>

            <hr class="text-gray-300 mt-10">

            <p class="font-normal text-gray-400 text-md text-center mt-5">&copy; 2021 Digital Agency. All rights
                reserved.</p>
